    ...
    render(){
      return(
        <section id="main-content-area" role="main">
            ...
            <h2 className="privacy_policy text-dark">Privacy Policy</h2>
             ...
             <div className="text-dark">
               <p class="h5 mb-0">Data protection is of high priority for the Technische Informationsbibliothek (TIB). As a general rule, the use of TIB’s services does not require the provision of any personal data. However, the processing of personal data may be required where a data subject wants to use special services via the TIB’s web pages. Where the processing of personal data is required and where there is no legal basis for such processing, we shall obtain the data subject’s consent.<br/><br/>
                ...
                <br/>
            <h3 className="text-dark">Name and address of the controller</h3>
               <p class="h5 mb-0">The controller under data protection law shall be:
					 <br /><br/>
            ...
            <h3 className="text-dark">Name and address of the data protection officer</h3>
                <p class="h5 mb-0">The data protection officer of the controller shall be:
                     <br /><br/>
                    Elke Brehm
                     <br />
                ...
                <br/>
            <h4 className="text-dark">Postal Address:</h4>
                <p class="h5 mb-0">Technische Informationsbibliothek (TIB)
                 <br />
            ...
            <h4 className="text-dark">Visiting Address:</h4>
                <p class="h5 mb-0">TIB Conti-Campus
                 <br />
