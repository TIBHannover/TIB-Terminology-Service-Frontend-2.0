...
export function ontologyPageTabTourSteps() {
  const steps = [
    ...
    },
    {
      ...
      content:
        "Explore the ontology class tree and check the classes metadata.",
    },
    {
      selector: tourSelectorPrefix + "property",
      content:
        "Explore the ontology property tree and check the properties metadata.",
    },
    {
      selector: tourSelectorPrefix + "individual",
      content:
        "Explore the ontology list of individuals (if exist) and check their metadata.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Read the community notes regarding this ontology or its classes/properties/individuals. You can as well create your own notes and reply to existing ones.",
    },
    {
      selector: tourSelectorPrefix + "gitIssues",
      content:
        "(If hosted on GitHub) Check the list of issues from the ontology GitHub repository, report issues, and request missing terms.",
    },
  ];
  ...
  const steps = [
    {
      ...
      content:
        "This is the ontology overview page where you can check the ontology metadata and statistics.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Click here to check if more metadata (e.g. creator, publisher, etc.) is available about this ontology.",
    },
    {
      selector: tourSelectorPrefix + "overview-page-show-metadata-as-json-btn",
      content:
        "Check this ontology complete metadata in JSON format in your browser.",
    },
  ];
  if (
    ...
    steps.push({
      ...
      content:
        "Request to add this ontology to one or more TIB collections if you believe it’s relevant. We will evaluate your request and include it if it meets the criteria.",
    });
  }
    ...
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              This is a {type}. You can click on it to check its detail on the
              right side of this page.
            </p>
            <p>
              <b>Hint: </b> You can use arrow keys{" "}
              <i className="fa fa-arrow-up"></i>/
              <i className="fa fa-arrow-down"></i> on your keyboard
              <i className="fa fa-keyboard-o"></i> to move between nodes and
              select them in this tree.
            </p>
          </>
        );
      },
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              You can use this to expand(+) or collapse(-) (in case it is
              already expanded) this {type} to see its children. In case you do
              not see these icons means this {type} is a leaf (has no child).
            </p>
            <p>
              <b>Hint: </b> You can use arrow keys{" "}
              <i className="fa fa-arrow-left"></i>/
              <i className="fa fa-arrow-right"></i> on your keyboard
...
export function individualsListTourSteps() {
  const steps = [
    ...
    },
    {
      ...
      content:
        "This an individual lable. You can click on it to check its detail on the right pane table.",
    },
    {
      selector: tourSelectorPrefix + "check-in-tree-individual",
      content:
        "Click here to check the selected individual in the class tree structure. You can use this to check the class that this individual instantiated from.",
    },
    {
      selector: tourSelectorPrefix + "tree-jumpto-box",
...
export function classListTourSteps() {
  const steps = [
    ...
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              Check this to only see the obsolete classes list. Unchecked means
              only show the non-obsolete classes.
            </p>
            <p>
              <b>Attention:</b> this enable the obsolete check globally for this
              application. This means obsolete checkbox will be enabled for all
              other section such as the search and tree view.
            </p>
          </>
        );
      },
    ...
    },
    {
      ...
      content:
        "Use this to hide a column from your view in case you like to have a smaller table.",
    },
  ];
  ...
  const steps = [
    {
      ...
      content: () => {
        return (
          <>
            <p>
              This the ontology GitHub panel (if hosted on GitHub). Here you can
              check the list of open issues, and also, open new issues and term
              requests.
            </p>
            <p>
              <b>Attention:</b> You can file a new issue or term request only if
              you login in TS via your GitHub account. Otherwise you can only
    ...
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              This is the filter for issues/pull-requests based on their status
              on GitHub.
            </p>
            <ul>
              <li>open (default)</li>
    ...
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              Here you can select the type of this list: issues and pull
              requests.
            </p>
    ...
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              Use this to open an issue for this ontology on its GitHub
              repository.
            </p>
            <p>
              <b>Attention:</b> If you plan to create a Term Request, use the
              other button below this.
            </p>
          </>
        );
      },
    },
    {
      ...
      content: () => {
        return (
          <>
            <p>
              Use this to request a new term for this ontology. The request will
              be an issue on the ontology repository. We provide a template for
              you to help you requesting the term.
            </p>
            <p>
              <b>Attention:</b> We cannot guarantee that your term request will
              be accepted. It is up to the ontology maintainers.
            </p>
          </>
        );
      },
...
export function notesTourSteps() {
  const steps = [
      ...
      content: () => {
        return (
          <>
            ...
            <p>
              This is the ontology notes panel. Here you can check the existing
              notes, create new notes, and add comment to other users notes.
            </p>
            <p>
              <b>Hint: What is a note exactly?</b>
            </p>
            <p>
              You can see the notes as the extra contexual data for an ontology
              or a term defined by the community (like a community note). Notes
              helps ontology users to understand and use the ontology better.
              Besides, it is a place to ask question about the ontology and its
              terms from the community.
            </p>
            <p>
              <b>Why use note and not GitHub issues for this?</b>
            </p>
            <p>
              <ul>
                <li>
                  Some ontologies are not hosted on GitHub (or any version
                  control system with an issue list feature.)
                </li>
                <li>
                  Some questions might not be suitable and accpetable as a Git
                  issue based on the target repository rules.
                </li>
                <li>
                  You can attach a note directly to a term and visit it on the
                  tree under note tab for the target term. Not possible on
                  GitHub.
                </li>
              </ul>
            </p>
            <br />
            <p>
              <b>Hint: </b>This is one of the good examples of using the note
              feature:
              <a
    ...
    },
    {
      ...
      content:
        "Here you can filter the note list (if exist) for this ontology based on the target type.",
    },
    {
  ...
  if (!window.location.href.includes("noteId=")) {
    steps.push({
      ...
      content:
        "Use this to define a new note for this ontology (you need to be logged in.)",
    });
  }
  ...
  if (noteList && noteList.length !== 0) {
    ...
    steps.push({
      ...
      content:
        "Creation date and made by whome. Besides, you will see Pinned tag if the note is pinned by admin and Imported tag if it is imported.",
    });
    steps.push({
      selector: tourSelectorPrefix + "onto-note-list-card-title",
      content:
        "This is the note title. You can click on it to check the note detail.",
    });
    steps.push({
      selector: tourSelectorPrefix + "onto-note-list-card-about",
      content:
        "Check this note describes which artifact: ontology, class, property, and individual. You can click on them to see the term details.",
    });
  }
