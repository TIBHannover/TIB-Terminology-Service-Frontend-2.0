                    ...
                    <div id="usage-accordion-1">
                        <div className="card">
                            <div className="card-header" id="usage-heading-1">
                                <h5 className="mb-0">
                                    <button className="btn btn-link collpase-text-btn" data-toggle="collapse" data-target="#usage-collapse-1" aria-expanded="false" aria-controls="usage-collapse-1">
                                        Archetype Golo
                                    </button>
                                </h5>
                            </div>

                            <div id="usage-collapse-1" className="collapse" aria-labelledby="usage-heading-1" data-parent="#usage-accordion-1">
                    ...
                    <div id="usage-accordion-2">
                        <div className="card">
                            <div className="card-header" id="usage-heading-2">
                                <h5 className="mb-0">
                                    <button className="btn btn-link collpase-text-btn" data-toggle="collapse" data-target="#usage-collapse-2" aria-expanded="false" aria-controls="usage-collapse-2">
                                        Academic Researcher
                                    </button>
                                </h5>
                            </div>

                            <div id="usage-collapse-2" className="collapse" aria-labelledby="usage-heading-2" data-parent="#usage-accordion-2">
                                <div className="card-body">
                                    <p className='justify'>
                    ...
                    <div id="usage-accordion-3">
                        <div className="card">
                            <div className="card-header" id="usage-heading-3">
                                <h5 className="mb-0">
                                    <button className="btn btn-link collpase-text-btn" data-toggle="collapse" data-target="#usage-collapse-3" aria-expanded="false" aria-controls="usage-collapse-3">
                                        Product Manager/Head of Department
                                    </button>
                                </h5>
                            </div>

                            <div id="usage-collapse-3" className="collapse" aria-labelledby="usage-heading-3" data-parent="#usage-accordion-3">
                                <div className="card-body">
                                    <p className='justify'>
                    ...
                    <div id="usage-accordion-4">
                        <div className="card">
                            <div className="card-header" id="usage-heading-4">
                                <h5 className="mb-0">
                                    <button className="btn btn-link collpase-text-btn" data-toggle="collapse" data-target="#usage-collapse-4" aria-expanded="false" aria-controls="usage-collapse-4">
                                        Knowledge Worker
                                    </button>
                                </h5>
                            </div>

                            <div id="usage-collapse-4" className="collapse" aria-labelledby="usage-heading-4" data-parent="#usage-accordion-4">
                                <div className="card-body">
                                    <p className='justify'>
