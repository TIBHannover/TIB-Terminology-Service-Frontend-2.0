...
const ContactForm = (props) => {
  ...
  function submit() {
    ...
    let username = !appErrorUrl
      ? FormLib.getFieldByIdIfValid("contact-form-username")
      : "";
    let email = !appErrorUrl
      ? FormLib.getFieldByIdIfValid("contact-form-email")
      : "";
    let safeAnswer = FormLib.getFieldByIdIfValid("contact-form-safe-q");
    let content = !appErrorUrl
      ? FormLib.getTextEditorValueIfValid(
          editorState,
        ...
        {formSubmitted && formSubmitSuccess && (
          <>
            ...
            <a
              ...
              href={process.env.REACT_APP_PROJECT_SUB_PATH + "/contact"}
            >
              New message
            </a>
          </>
        ...
        {!formSubmitted && (
          <>
            ...
            <div className="row">
              <div className="col-sm-8">
                <label
                  className={!appErrorUrl ? "required_input" : ""}
                  htmlFor="contact-form-title"
                >
            ...
            <div className="row mt-4">
              <div className="col-sm-6">
                <label className="required_input" htmlFor="contact-form-safe-q">
