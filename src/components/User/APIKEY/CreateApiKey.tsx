...
const CreateApiKey = () => {
  ...
  function submit() {
    if (!title) {
      let titleBox = document.getElementById(
        "apikey-title",
      ) as HTMLInputElement;
        ...
        <div className="row text-center">
          <div className="col-sm-12">
            <div className="alert alert-success">
              Your API key has been created successfully. Please copy it to your
              clipboard since you will not be able to see it again.
              <br />
              <br />
              Your API key is:
              <br />
              ...
              <CopyLinkButton
                valueToCopy={key}
                tooltipText={"Copy your API key to clipboard"}
              />
            </div>
          </div>
        </div>
