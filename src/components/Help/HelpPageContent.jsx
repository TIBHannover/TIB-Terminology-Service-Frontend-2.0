    ...
    <div>
      ...
      <p>For feedback, enquiries or suggestion about TIB Terminology Service:
        <b><a className="btn-secondary btn btn-sm ms-1 pt-0 pb-0 pl-1 pr-1"
              href={process.env.REACT_APP_PROJECT_SUB_PATH + "/contact"}>Contact us</a></b></p>
      <p>To request a new terminology: <b><a className="btn-secondary btn btn-sm pt-0 pb-0 pl-1 pr-1"
                                             href={process.env.REACT_APP_PROJECT_SUB_PATH + "/ontologysuggestion"}>Ontology
        suggestion</a></b> (requires sign-in)</p>
      <br/>
      ...
      <p>You can integrate TIB Terminology Service into your own applications via its REST API (see <b><a
        href={'https://service.tib.eu/ts4tib/swagger-ui.html'} target="_blank">Documentation</a></b>)</p>
      ...
      <p>If you want to suggest a new terminology to be added to TIB Terminology Service use: <a
        className="btn btn-secondary btn-sm pt-0 pb-0 pl-1 pr-1"
        href={process.env.REACT_APP_PROJECT_SUB_PATH + "/ontologysuggestion"}>Ontology suggestion</a></p>
      ...
      <p>Make a request at <b><a className="btn btn-secondary btn-sm pt-0 pb-0 pl-1 pr-1"
                                 href={process.env.REACT_APP_PROJECT_SUB_PATH + "/ontologysuggestion"}>Ontology
        suggestion</a></b>.</p>
      ...
      <ul>
        ...
        <li><b><a href={"https://www.din.de/de/service-fuer-anwender/terminologie/din-term"}
                  target="_blank">DIN-TERMinologieportal</a></b> (search for terms and definitions from German
          standards, requires registration)
        </li>
        <li><b><a href={"https://www.din.de/de/service-fuer-anwender/terminologie/din-termonline"} target="_blank">DINTerm
      ...
      <p>A list of further services is provided by <a href={"https://bartoc.org/registries"} target="_blank">Bartoc</a>.
      </p>
    </div>
  ];
