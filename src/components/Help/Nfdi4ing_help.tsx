          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                specialized concepts, relations between these concepts as well
                as the necessary terms to communicate about these concepts. As
                such, terminology is the most important tool for any kind of
                collaboration among experts, e.g. formulating research
                hypotheses as well as collecting, analysing and interpreting
                research data.
              </p>
            </div>
          </div>
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                already used and needed much earlier than that and also plays a
                role in professional research data management: Research data on
                their own are useless. Without annotations and accompanying
                information (e.g. about the data elicitation process, data
                transformations, or data analysis) data are simply meaningless
                and not fit for reuse. These “data about data” are called
                metadata. Metadata are key to making data discoverable and
                reusable in future contexts. They are usually given in a
                well-structured format following a recognized schema, often with
                expected and authorized sets of values. Naturally,
                domain-specific metadata need to make use of a domain’s
                terminology – ideally in a consistent and harmonized manner and
                with means of persistent reference.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-header" id="usage-heading-3">
            <h5 className="mb-0">
              ...
              >
                How can I use NFDI4Ing’s Terminology Service for research data
                management?
              </button>
            </h5>
          </div>
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                definition and other types of information, from a range of
                engineering-related terminology collections. Each concept is
                represented by a
                <a
                ...
                . You can use the URI of a fitting concept (instead of a
                potentially ambiguous natural language expression!) for your
                research data documentation and annotation and thus persistently
                ...
                . In the future, the terminology from the Terminology Service
                will also be integrated into other NFDI4Ing services for
                research data management where it makes terminology available
                for standardized data description – increasing the Findability,
                Interoperability and Reusability of research data in the
                NFDI4Ing overall infrastructure.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                . If you know of a source containing relevant terminology, you
                can also suggest this at the issue tracker. Please notice, that
                a terminology collection can be ingested fastest, if it comes in
                a certain format and with a free license. Other terminology
                sources will need additional processing steps or might not be
                eligible at all.
              </p>
            </div>
          </div>
          ...
          <div className="card-header" id="usage-heading-5">
            <h5 className="mb-0">
              <button
                ...
                aria-expanded="false"
                aria-controls="usage-collapse-5"
              >
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                that are ready for the Semantic Web. Terminology that is
                documented in other forms, needs to be transformed for an
                ingest. A terminology should therefore use one of the
                serializations RDF/XML (.rdf/.owl), Turtle (.ttl) and OBO
                (.obo). Terminologies in a tabular format (.tsv, .csv, .xlsx) or
                in mark-up languages like XML (.xml) are not ready for ingest
          ...
          <div className="card-header" id="usage-heading-6">
            <h5 className="mb-0">
              <button
                ...
                aria-expanded="false"
                aria-controls="usage-collapse-6"
              >
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                look up standardized terms and definitions.
                <ul>
                  <li>
                    <a
                  ...
                  <li>
                    ...
                    (search for terms and definitions from German standards,
                  ...
                  <li>
                    ...
                    (search for terms and approved translations, available
                    without registration)
                  </li>
                </ul>
                A multiple domain search for terms is also possible on services
                like
                <ul>
                  <li>
                    <a
                ...
                The following services allow the search for terminological
                collections from different domains or for specific sub-fields
          ...
          <div className="card-header" id="usage-heading-7">
            <h5 className="mb-0">
              <button
                ...
                aria-expanded="false"
                aria-controls="usage-collapse-7"
              >
                Are there further benefits for ontological terminology
                management for research data management?
              </button>
            </h5>
          </div>
          <div
          ...
          >
            <div className="card-body">
              <p className="justify">
                ...
                to enable unambiguous and semantically enriched access to
                distributed datasets. They will function as the corner stone for
                a semantic web of data, enabling effective access and
                machine-actionable processing of information, easy and
                unambiguous exchange of data over system barriers, as well as
                the automation of related processes and reuse of data.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card-header" id="usage-heading-8">
            <h5 className="mb-0">
              <button
                ...
                aria-expanded="false"
                aria-controls="usage-collapse-8"
              >
          ...
          >
            <div className="card-body">
              <p className="justify">
                <ul>
                  <li>
                    The FAIR Cookbook: a deliverable of the FAIRplus project
                    (grant agreement 802750), funded by the IMI programme, a
                    private-public partnership that receives support from the
                    European Union’s Horizon 2020 research and innovation
                    programme and EFPIA Companies. Introduction to terminologies
                    and ontologies{" "}
                    <a
          ...
          <div className="card-header" id="usage-heading-9">
            <h5 className="mb-0">
              <button
                ...
                aria-expanded="false"
                aria-controls="usage-collapse-9"
              >
              ...
              <p className="justify">
                <ul>
                  <li>
                    ...
                    ontology of a project can then be visualised in different
                    formats.
                  </li>
                </ul>
              </p>
