export function tibDoc(){
    let content = [
        <div>
            ...
            <p>The service also offers an API that allows to retrieve information on terms and their relations as json data for use in other webservices, e.g. in services of the research data management infrastructure of various research communities. In applications like research data management systems, ontological terms and their unique identifiers can, for example, be used as metadata on research data artifacts - thereby making research (meta)data more findable and interoperable. The REST API interface of the TIB Central Terminology Service starts with <b><a href="https://service.tib.eu/ts4tib/api">https://service.tib.eu/ts4tib/api</a></b>. This API enables to query all the terminologies of various research communities maintained by TIB. The methodology on how to use this interface is explained in the <b><a href="https://service.tib.eu/ts4tib/swagger-ui.html">Swagger Documentation</a></b> in detail. The underlying models can also be viewed through this documentation for a deeper understanding of the API commands. Besides, it is possible to execute the publicly available API commands from the <b><a href="https://service.tib.eu/ts4tib/swagger-ui.html">Swagger Documentation</a></b></p>
            <br/>
            <h3>Report an Issue</h3>
            <p>For feedback, enquiries or suggestion about TIB TS or to request a new ontology please use our <b><a href="https://gitlab.com/TIBHannover/terminology/tib-terminology-service-issue-tracker" target="_blank" rel="noopener noreferrer">GitLab issue tracker</a></b>. For more information, you can contact TIB.</p>
        </div>
    ];
