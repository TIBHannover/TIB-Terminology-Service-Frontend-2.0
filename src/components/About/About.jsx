...
import NFDI4CHEMSERVICE from "../../assets/img/nfdi4chemservice.png"
...
class About extends React.Component{
    render(){
        return(
            <div>
                <br/>
                {process.env.REACT_APP_SHOW_NFDI4CHEM_ABOUT === "false" &&
                <div>
                  ...
                  <br/>
                  <img src={NFDI4CHEMSERVICE} alt="nfdi4chemservice"/>
                  <br/><br/>
                ...
                {process.env.REACT_APP_REMOVE_TIB_ABOUT === "true" &&
                <div>
