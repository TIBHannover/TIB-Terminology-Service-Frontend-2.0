...
const TermDetail = (props: TermDetailComPros) => {
    ...
    */
    ...
    for (let tab of Object.values(NodePageTabConfig)) {
        Tabs[tab['urlEndPoint'] as string] = tab['tabId'];
    }
    ...
    function setTabOnLoad() {
        ...
        if (requestedTab !== lastRequestedTab) {
            activeTabId = Tabs[requestedTab as keyof typeof Tabs] ?? DETAIL_TAB_ID;
        }
