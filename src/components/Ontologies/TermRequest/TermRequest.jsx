  ...
  */
  ...
  return (
    <>
      ...
      {modalIsOpen &&
        <div className="modal" id={props.reportType + "_issue_modal"}>
          <div className="modal-dialog modal-xl">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button onClick={closeModal} type="button" className="close close-mark-btn" data-dismiss="modal">&times;</button>
              </div>
              <br></br>
              <span>
                {!submitFinished &&
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-sm-12 d-flex justify-content-center">
                        <button type="button" className="btn btn-secondary" onClick={goBackToModalContent}>Go Back</button>
                      </div>
                    </div>
                  </div>
                }
                {!submitFinished &&
                  <button type="button" className="btn btn-secondary submit-term-request-modal-btn" onClick={submitIssueRequest}>Submit</button>
                }
              </div>
            </div>
          </div>
