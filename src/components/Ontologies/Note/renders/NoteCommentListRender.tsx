...
export const NoteCommentListRender = (props: NoteCommentListRenderProps) => {
      ...
      result.push(
        <RowWithSingleColumn
          content={
            <CommentCard
              comment={comment}
              commentEditHandler={props.handleEditButton}
            />
          }
  ...
  const submitButton = !props.editMode && (
    <button
      type="button"
      className="btn btn-secondary note-comment-submit-btn"
  ...
  const cancelButton = props.editMode && (
    <button
      type="button"
      className="btn btn-secondary note-comment-cancel-edit-btn"
