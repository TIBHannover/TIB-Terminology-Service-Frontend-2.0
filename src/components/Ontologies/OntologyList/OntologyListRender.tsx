...
type CmpProps = {
    ...
    pageNumber: number;
    pageSize: number;
    handlePageSizeDropDownChange: (e: React.ChangeEvent<HTMLSelectElement>) => void;
    sortField: string;
            ...
            <div className='col-sm-12'>
                <div className='row'>
                    <div className='col-sm-6'>
                        <h3 className='h-headers stour-onto-list-browse'>Browse Ontologies
                            ({props.ontologies.length})</h3>
                    </div>
                </div>
