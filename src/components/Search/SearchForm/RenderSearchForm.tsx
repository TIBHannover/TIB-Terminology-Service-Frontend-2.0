...
const RenderSearchForm = (props: CmpProps) => {
  ...
  function renderAutoCompleteResult() {
    ...
    for (let result of props.autoCompleteResult) {
      resultList.push(
        <Link
          to={props.setSearchUrl(result["autosuggest"])}
          key={key}
          className="container"
          data-value={result["autosuggest"]}
          onClick={(e) => {
  ...
  function renderJumpToResult() {
    ...
    for (let result of props.jumpToResult) {
      resultList.push(
        <div className="row mb-3">{setJumpResultButtons(result)}</div>,
      );
    }
    return resultList;
  }
  ...
  function setJumpResultButtons(resultItem: BaseSearchSingleResult) {
    ...
    let targetHref =
      ...
      "/ontologies/" +
      encodeURIComponent(resultItem["ontology_name"]);
      ...
      >
        <div className="item-for-navigation">
          ...
          {resultItem["type"] !== "ontology" && (
            <div className="jumpto-badge-onto bg-main-color">
  ...
  async function handleUserCollectionClose() {
    ...
    userSttings.userCollectionEnabled =
        ...
        <div className="col-sm-8 search-bar-container stour-searchbox">
          ...
          {process.env.REACT_APP_PROJECT_ID === "nfdi4ing" && (
            <p>
              <span className="examples">
                Examples:{" "}
                <Link className="example-link" to="search?q=electric+vehicle">
                  electric vehicle
                </Link>
                ,
          ...
          <div className="row site-header-search-filters-container mt-1">
            ...
            <div className="col-lg-3 col-sm-3 search-form-checkbox-holders stour-searchbox-include-imported">
              ...
              <label
                className="form-check-label ms-2"
                htmlFor="include-imported-checkbox"
              >
                Include imported terms
              </label>
            </div>
            {process.env.REACT_APP_ADVANCED_SEARCH === "true" && (
              <div className="col-lg-4 col-sm-3 adv-search-title-holder stour-searchbox-advanced">
                <div className="row">
                  <div className="col-sm-12">
                    <div className="form-switch">
                      ...
                      />
                      <label
                        className="form-check-label  search-form-checkbox-holders"
                        htmlFor="adv-search-toggle"
                      >
                        Advanced search
                      </label>
                    </div>
