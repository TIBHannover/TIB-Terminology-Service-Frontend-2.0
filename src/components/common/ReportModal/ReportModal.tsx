      ...
      <Modal show={showModal} id={"reportModal" + props.modalId}>
        <Modal.Header className="row">
          <div className="col-sm-6">
            <h5 className="modal-title" id={"reportModalLabel" + props.modalId}>
              Report Content
            </h5>
          </div>
        ...
        <Modal.Body>
          {!submited && (
            <>
              <div className="mb-3">
                <label
                  htmlFor={"reportReason" + props.modalId}
                  className="form-label"
                >
                  Please describe briefly the reason for this report
                </label>
                <textarea
                  className="form-control"
                  id={"reportReason" + props.modalId}
                  rows={3}
                ></textarea>
              </div>
              <Link
