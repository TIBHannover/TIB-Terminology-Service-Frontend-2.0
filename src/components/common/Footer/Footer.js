        ...
        <div className='row site-footer'>
            ...
            <div className="col-sm-2">
                ...
                <ul className="footer-list">
                    ...
                    {process.env.REACT_APP_PROJECT_ID === "nfdi4ing" &&
                        <li>Join <a href="https://www.linkedin.com/showcase/nfdi4ing-terminology-service/?viewAsMember=true"> <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" alt="linkedin" width="20" height="20"></img> Page</a></li>
                    }
                    {process.env.REACT_APP_PROJECT_ID === "nfdi4ing" &&
