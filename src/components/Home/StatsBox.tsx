      ...
      <div className="row">
        <div className="col-lg-3 col-sm-6 pb-3 pt-3">
          <div className="pl-3 pr-3">
            ...
            <h4 className="font-weight-bold h2 mb-1">
              {statsResult.numberOfOntologies}
            </h4>
        ...
        <div className="col-lg-3 col-sm-6 pb-3 pt-3">
          <div className="pl-3 pr-3">
            ...
            <h4 className="font-weight-bold h2 mb-1">
              {statsResult.numberOfProperties}
            </h4>
        ...
        <div className="col-lg-3 col-sm-6 pb-3 pt-3">
          <div className="pl-3 pr-3">
            ...
            <h4 className="font-weight-bold h2 mb-1">
              {statsResult.numberOfIndividuals}
            </h4>
