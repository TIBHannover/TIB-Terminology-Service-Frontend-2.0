...
class SearchUrlFactory {
  ...
  constructor() {
    ...
    this.includeImported = url.searchParams.get(
    ...
    this.fromOntologyPage = url.searchParams.get(
      SiteUrlParamNames.FromOntologyPage,
    );
    this.obsoletes = url.searchParams.get(SiteUrlParamNames.Obsoletes);
  }
